      ...
      <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-4">
              <div className="text-center xl:text-left order-2 xl:order-none">
                ...
                <h1 className="h1 mb-6">
                  Hello I'm <br/> <span className="text-accent-default">Soufiane refai</span>
                </h1>
                ...
                <div className="flex flex-col xl:flex-row items-center gap-8">
                  ...
                  <div className="mb-8 xl:mb-8">
                    ...
                    justify-center items-center text-accent-default text-base hover:bg-accent-default hover:text-primary
