"use client"
import {FaHtml5, FaCss3, FaJs,FaLaravel,FaPhp,FaReact,FaVuejs,FaNodeJs,FaFigma,FaJira, FaBootstrap,FaJava,FaPython} from "react-icons/fa";
import {SiTailwindcss,SiNextdotjs,SiMysql, SiMongodb,SiDocker,SiGit,SiWordpress} from "react-icons/si";
        ...
        {/* Experience */}
            <TabsContent value="experience" className="w-full">
                <div className="flex flex-col gap-[30px] text-center xl:text-left">
                    ...
                    <p className="max-w[600px] text-white/60 mx-auto xl:mx-0 capitalize">{experience.description}</p>
         ...
         {/* Education */}
            ...
            <div className="flex flex-col gap-[30px] text-center xl:text-left">
                    ...
                    <p className="max-w[600px] text-white/60 mx-auto xl:mx-0 capitalize">{education.description}</p>
                    <ScrollArea className="h-[400px]">
                        <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
            ...
            <TabsContent value="skills" className="w-full h-full">
                <div className="flex flex-col gap-[30px] ">
                    <div className="flex flex-col gap-[30px] text-center xl:text-left">
                            ...
                            <p className="max-w-[600px] text-white/60  mx-auto xl:mx-0 capitalize">{skills.description}</p>
                    </div>
                        ...
                        {about.infos.map((el,index)=>{
                            return(
                                <li key={index} className="flex items-center justify-center xl:justify-start gap-4">
                                    <span className="text-white/60 capitalize">{el.fieldName}</span>
                                    <span className="text-xl capitalize">{el.value}</span>
                                </li>
                            )
                        })}
                    </ul>
